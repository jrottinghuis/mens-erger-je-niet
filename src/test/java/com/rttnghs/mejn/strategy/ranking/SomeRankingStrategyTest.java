...
import com.rttnghs.mejn.internal.TestBoardState;
...
class SomeRankingStrategyTest {
	...
	final void test() {
		...
		BoardState boardState = MyTestBoardState.myOf("(40)[P0={H0};P1={B4}]");
		assertThrows(IllegalArgumentException.class, () -> strategy.choose(null, boardState));

		choices = Arrays.asList(Move.of("<E3->E4>"), Move.of("<E19->H20>"));

		BoardState boardState2 = MyTestBoardState
				.myOf("(40)[P0={H0,H1,H2,H3};P1={B4,B4,B4,E25};P2={E3,E19,H22,H23};P3={B24,B24,E34,H33}]");
		Move choice = strategy.choose(choices, boardState2);
		assertEquals("<E19->H20>", choice.toString());

		// Assume somebody else is at E4
		BoardState boardState3 =  MyTestBoardState
				.myOf("(40)[P0={E3,E19,H22,H23};P1={B4,B4,B4,E25};P2={E4,H1,H2,H3};P3={B24,B24,E34,H33}]");
		choice = strategy.choose(choices, boardState3);
